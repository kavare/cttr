...
export const translations = {
  en: {
    ...
    landing: {
      ...
      bioText: `Over the past 12+ years, I've been finding my way across three continents, living and working through Paris, London, Taipei, and California. I started as an early engineer at Beamery (now a unicorn), grew into a Tech Lead at Meta, and currently serve as an Engineering Manager at Datadog. Along the way, I've crossed Siberia by rail, summited Kilimanjaro, trekked the Annapurna circuit, and road tripped Route 66 with a one year old in tow. This book distills everything I've learned about navigating visa processes, cultural shifts, and the challenges of building a career far from home into a practical guide for anyone dreaming of working abroad.`,
  ...
  'zh-tw': {
    ...
    landing: {
      ...
      bioText: '過去 12 年多來，我一邊摸索一邊前行，在巴黎、倫敦、台北和加州之間輾轉生活與工作。我從 Beamery（現已成為獨角獸）的早期工程師開始，成長為 Meta 的技術主管，目前擔任 Datadog 的工程經理。一路走來，我搭乘西伯利亞鐵路橫跨大陸、登上吉力馬扎羅山、走過安納普爾納環線，更帶著一歲的孩子完成了美國 66 號公路的公路旅行。這本書將我在簽證流程、文化轉變，以及在異鄉建立職涯過程中所學到的一切，濃縮成一本實用的指南，獻給每一個夢想到海外工作的人。',
      heroCtaText: '開始你的旅程',
  ...
  ja: {
    ...
    landing: {
      ...
      bioText: '12年以上かけて、パリ、ロンドン、台北、カリフォルニアと3つの大陸で暮らし、働いてきました。ユニコーン企業Beameryの初期エンジニアからスタートし、Metaのテックリードを経て、現在はDatadogのエンジニアリングマネージャーを務めています。シベリア鉄道で大陸を横断し、キリマンジャロに登り、アンナプルナを一周し、1歳の子どもとルート66も走りました。ビザの壁、文化の違い、異国でゼロからキャリアを築く中で学んだことの全てを、この一冊にまとめています。',
      heroCtaText: 'ワークを始める',
  ...
  ko: {
    ...
    landing: {
      ...
      bioText: '지난 12년간 파리, 런던, 타이베이, 캘리포니아를 오가며 세 대륙에서 살고 일해 왔습니다. 유니콘 기업 Beamery의 초기 엔지니어로 시작해 Meta의 테크리드를 거쳐 현재 Datadog에서 엔지니어링 매니저로 일하고 있습니다. 시베리아 횡단열차를 타고 대륙을 건넜고, 킬리만자로 정상에 올랐고, 안나푸르나 서킷을 걸었고, 한 살짜리 아이와 함께 루트 66을 달리기도 했습니다. 비자 문제, 문화 차이, 타국에서 처음부터 커리어를 만들어가는 과정에서 배운 모든 것을 이 한 권에 담았습니다.',
      heroCtaText: '실습 시작하기',
